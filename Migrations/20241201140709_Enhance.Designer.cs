...
namespace YalabenaApi.Migrations
{
    ...
    [Migration("20241201140709_Enhance")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YalabenaApi.Models.Activity", b =>
                {
                    ...
                    b.Property<int>("ItinerariesItineraryID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ItinerariesItineraryID");
            ...
            modelBuilder.Entity("YalabenaApi.Models.Transportation", b =>
                {
                    ...
                    b.Property<int>("ActivitiesActivity_Id")
                        .HasColumnType("int");

                    b.Property<DateTime>("Activity_Duration")
                        .HasColumnType("datetime2");

                    b.Property<int>("PreferencesPrre_Id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ActivitiesActivity_Id");

                    b.HasIndex("PreferencesPrre_Id");
            ...
            modelBuilder.Entity("YalabenaApi.Models.Activity", b =>
                {
                    b.HasOne("YalabenaApi.Models.Itinerary", "Itineraries")
                        .WithMany("Activities")
                        .HasForeignKey("ItinerariesItineraryID")
            ...
            modelBuilder.Entity("YalabenaApi.Models.Transportation", b =>
                {
                    b.HasOne("YalabenaApi.Models.Activity", "Activities")
                        .WithMany("Transportations")
                        .HasForeignKey("ActivitiesActivity_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("YalabenaApi.Models.Preference", "Preferences")
                        .WithMany()
                        .HasForeignKey("PreferencesPrre_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
